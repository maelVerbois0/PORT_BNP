...
double MasterProblem::get_column_value(int id) const{
    return column_vars_[id].get(GRB_DoubleAttr_X);
}

void MasterProblem::enable_columns(const std::vector<int>& col_id){
    for(int id : col_id){
